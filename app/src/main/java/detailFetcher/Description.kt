...
class Description : AppCompatActivity() , View.OnClickListener{
    ...
    fun aaila(){
        ...
        if(editAge.text.toString().isEmpty()){
            AgeError?.setText("ENTER YOUR AGE!")
            b1 = false;
        ...
        if(editWeight.text.toString().isEmpty()){
            WeightError?.setText("ENTER WEIGHT!")
            b2 = false
            //Statified.descriptionBool = false
        }
        else{
        ...
        if(gender == "none"){
            errorGender.setText("SELECT YOUR GENDER!")
            b3 = false
            //Statified.descriptionBool = false
        }
        else{b3 = true}
        ...
        if(heightFt == 0){
            errorHeight.setText("SELECT YOUR HEIGHT!")
            b4 = false
            //Statified.descriptionBool = false
        }
        else{b4 = true}
        ...
        if(activity == "none"){
            errorActivity.setText("ENTER ACTIVITY!")
            b6 = false
            //Statified.descriptionBool = false
        }
        else{
